...
public class SwiftCheckoutFlutterPlugin: NSObject, FlutterPlugin {
  ...
  public func handle(_ call: FlutterMethodCall, result: @escaping FlutterResult) {
    ...
    TapCheckout.secretKey = secretKey
    TapCheckout.mode = sdkMode
    TapCheckout.language = sdkLang
...
extension SwiftCheckoutFlutterPlugin: SessionDataSource {
...
extension SwiftCheckoutFlutterPlugin: SessionDelegate {
...
extension SwiftCheckoutFlutterPlugin: SessionAppearance {
...
//     private var checkoutFlutterSession: CheckoutFlutterSession?
//     var showDragHandler:Bool {
//         return checkoutFlutterSession?.closeButtonTitleStyle == .icon
//     }
//
//     private var argsParameters:[String:Any]?
//     var argsDataSource:[String:Any]?{
//       didSet{
//         argsParameters = argsDataSource as? [String : Any]
//       }
//     }
//
//   public static func register(with registrar: FlutterPluginRegistrar) {
...
//       do {
//           checkoutFlutterSession = try CheckoutFlutterSession(with: arguments)
//           let dict = call.arguments as? [String: Any]
...
//       } catch {
//           print("error: \(error)")
//           checkoutFailedSDKError(with: error as! ParsingErrors, result: result)
//       }
//   }
//
//     func startSDKClicked() {
//         guard let checkoutFlutterSession = checkoutFlutterSession else {
//             // need to throw error
//             return
//         }
//
...
//         TapCheckout.localeIdentifier = checkoutFlutterSession.sdkLanguage//"en"//localeID
//         TapCheckout.secretKey = .init(sandbox: checkoutFlutterSession.sandBoxSecretKey, production: checkoutFlutterSession.productionSecretKey)
// //            .init(sandbox: "sk_test_cvSHaplrPNkJO7dhoUxDYjqA", production: "sk_live_V4UDhitI0r7sFwHCfNB6xMKp")
//
//
//         checkout.build(
//             localiseFile: nil,
//             customTheme: nil,
//             delegate: self,
//             currency: checkoutFlutterSession.currency,//selectedCurrency,
//             amount: checkoutFlutterSession.amount,//0,//amount,
//             items: checkoutFlutterSession.items,
//             swipeDownToDismiss: true,
//             paymentType: .All,//paymentTypes.first ?? .All,
//             closeButtonStyle: checkoutFlutterSession.closeButtonTitleStyle,//closeButtonTitleStyle,
//             showDragHandler:showDragHandler,
//             transactionMode: checkoutFlutterSession.transactionMode,//.purchase,
//             customer: checkoutFlutterSession.customer,
//             tapMerchantID: "1124340",
//             require3DSecure: false,
//             sdkMode: checkoutFlutterSession.sdkMode,//.sandbox,
//             onCheckOutReady: {[weak self] tapCheckOut in
//                 DispatchQueue.main.asyncAfter(deadline: .now() + .seconds(0)) {
//                     self?.presentInCurrentViewController(with: tapCheckOut)
//                 }
//             })
//     }
//
//     private func presentInCurrentViewController(with tapCheckOut: TapCheckout) {
//         var topVC: UIViewController
//         // iOS13 or later
//         if #available(iOS 13.0, *) {
//
//             guard let windowScene = UIApplication.shared.connectedScenes.first as? UIWindowScene,
//                   let window = windowScene.windows.first, let rootViewController = window.rootViewController else { return }
//
//             topVC = rootViewController
//             // iOS12 or earlier
//         } else {
//             guard let window = UIApplication.shared.delegate?.window, let rootViewController = window?.rootViewController else { return  }
//             topVC = rootViewController
//         }
//
//         tapCheckOut.start(presentIn: topVC)
//     }
//
//
//     private func checkoutFailedSDKError(with error: ParsingErrors, result: FlutterResult) {
//         var resultMap: [String: Any] = [:]
//         resultMap["sdk_result"] = "SDK_ERROR"
//         resultMap["sdk_error_message"] = "Failed Initiating the SDK"
//         resultMap["sdk_error_description"] = error.description
//
//         result(resultMap)
//     }
...
// }
//
// extension CheckoutFlutterPlugin:CheckoutScreenDelegate {
