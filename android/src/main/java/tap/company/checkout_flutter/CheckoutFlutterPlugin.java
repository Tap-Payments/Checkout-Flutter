 ...
 */
public class CheckoutFlutterPlugin implements MethodChannel.MethodCallHandler, FlutterPlugin, ActivityAware {
...
//                delegate.saveStateBeforeResult();
  ...
  private CheckoutSDKDelegate delegate;
  ...
  private static final String CHANNEL = "checkout_flutter";
  ...
  public static void registerWith(PluginRegistry.Registrar registrar) {
    ...
    CheckoutFlutterPlugin plugin = new CheckoutFlutterPlugin();
  ...
  private void setup(
    ...
    channel = new MethodChannel(messenger, "checkout_flutter");
...
//            lifecycle.addObserver(observer);
  ...
  private final CheckoutSDKDelegate constructDelegate(final Activity setupActivity) {
    return new CheckoutSDKDelegate(setupActivity);
  }
...
//
///** CheckoutFlutterPlugin */
//public class CheckoutFlutterPlugin implements FlutterPlugin, MethodCallHandler {
...
//    channel = new MethodChannel(flutterPluginBinding.getBinaryMessenger(), "checkout_flutter");
//    channel.setMethodCallHandler(this);
//  }
//
//  @Override
